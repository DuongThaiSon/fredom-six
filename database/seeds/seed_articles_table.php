    ...
    public function run()
    {
        ...
        DB::table('articles')->insert(
            [
                ...
                'description' => '<p>BTN báo đẹp</p>',
                'detail' => '<p>This collection is so well organised – the best I’ve ever seen from here. The ideas are also really fresh and new – great work. I cant wait to start work with it!</p>',
                'is_new' => '1',
                'is_highlight' => '1',
                'is_public' => '1',
                'slug' => 'huyen-anh',
