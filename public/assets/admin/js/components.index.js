...
$(document).ready(function () {
    ...
    $('#table').DataTable({
      ...
      columns: [{
        ...
        render: function render(data) {
          return "\n                            <a href=\"#componentDetailModal\" data-toggle=\"modal\" data-id=\"".concat(data.id, "\"></a>\n                            <a href=\"/admin/components/").concat(data.id, "\"\n                                class=\"btn btn-sm p-1 btn-destroy\" data-toggle=\"tooltip\" title=\"Xo\xE1\">\n                                <i class=\"material-icons\">delete</i>\n                            </a>");
        },
        searchable: false
      }],
  ...
  function initComponentFormData() {
    ...
    $("#componentDetailModal").on('show.bs.modal', function (e) {
      ...
      var componentId = source.data('id');

      var _modal = $(this);

      if (componentId) {
        $.ajax({
          url: "/admin/components/".concat(componentId, "/edit"),
    ...
    $(".btn-update-component").on("click.initComponentFormData", function (e) {
      ...
      var _modal = $("#componentDetailModal");
      ...
      var componentId = _modal.find("input[name=id]").val();
      ...
      $.ajax({
        url: "/admin/components/".concat(componentId),
        method: 'POST',
        data: formData,
        success: function success() {
          $('#table').DataTable().draw('page');
...
/***/ 15:
/*!******************************************************!*\
  !*** multi ./resources/js/admin/components.index.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ACER\Desktop\son\fredom-six\resources\js\admin\components.index.js */"./resources/js/admin/components.index.js");
