...
filePond = __webpack_require__(/*! ../filepond */ "./resources/js/filepond.js");
$(document).ready(function () {
  console.log('lleh');
  var galleryId = $('input[name=id]').val();
  filePond.initFilePond('gallery-images', "/admin/gallery/".concat(galleryId));
});
...
/*!**********************************!*\
  !*** ./resources/js/filepond.js ***!
  \**********************************/
/*! exports provided: initFilePond */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFilePond", function() { return initFilePond; });
...
function initFilePond(inputId, rootUrl) {
  ...
  pond.setOptions({
    ...
    server: {
      ...
      process: {
        ...
        withCredentials: false,
        headers: {
          'X-CSRF-TOKEN': "".concat(window.csrfToken),
