...
$(document).ready(function () {
  var pageId = $("#page-id").val(); // Add active class

  $(".menu-" + pageId).parent().addClass("active");
  $(".menu-" + pageId).parents("div").addClass("show");
  $(".menu-" + pageId).parent("li").parents("li").addClass("active");
  console.log(pageId); // sidebar toggle
