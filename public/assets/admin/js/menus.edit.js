...
$(document).ready(function () {
  var CUSTOM_LINK = 0;
  var LINK_TO_ARTICLE_CATEGORY = 1;
  var SYNC_WITH_ARTICLE_CATEGORY = 2;
  var SYNC_WITH_ALL_ARTICLE_CATEGORIES = 3;
  var LINK_TO_ARTICLE = 4;
  var LINK_TO_PRODUCT_CATEGORY = 5;
  var SYNC_WITH_PRODUCT_CATEGORY = 6;
  var SYNC_WITH_ALL_PRODUCT_CATEGORIES = 7;
  var LINK_TO_PRODUCT = 8;
  var listArticleCategoriesUrl = $('#listArticleCategories').val();
  var showArticleCategoryUrl = $('#showArticleCategory').val();
  var listProductCategoriesUrl = $('#listProductCategories').val();
  var showProductCategoryUrl = $('#showProductCategory').val();
  var listArticlesUrl = $('#listArticles').val();
  var listArticlesDatatablesUrl = $('#listArticlesDatatables').val();
  var showArticleUrl = $('#showArticle').val();
  var listProductsUrl = $('#listProducts').val();
  var showProductUrl = $('#showProduct').val();
  var listProductsDatatablesUrl = $('#listProductsDatatables').val();
  validateFormInput();
  chooseAnotherRecord();
  ...
  var hideResultZone = function hideResultZone() {
    $('.result-zone').html('');
  };

  var showListing = function showListing(listingUrl) {
    var ajax = $.ajax({
      url: listingUrl,
  ...
  var chooseRecord = function chooseRecord() {
    ...
    $('.choose-record').on('click.chooseRecord', function (e) {
      ...
      $.ajax({
        url: "".concat(showRecordUrl, "?object_id=").concat(objectId),
    ...
    $('#datatables').DataTable({
      ...
      columns: [{
        ...
        render: function render(data) {
          return "\n                        <a href=\"#\" data-id=\"".concat(data.id, "\" class=\"btn btn-sm p-1 choose-record\" style=\"padding:0;\" data-toggle=\"tooltip\" title=\"Ch\u1ECDn\">\n                            <i class=\"material-icons\">library_add</i> Ch\u1ECDn\n                        </a>\n                        ");
        },
        searchable: false
      }],
  ...
  function validateFormInput() {
    ...
    $("#submit-menu-form").on("submit.validateFormInput", function (e) {
      ...
      if ((selectedType === LINK_TO_ARTICLE_CATEGORY || selectedType === SYNC_WITH_ARTICLE_CATEGORY || selectedType === LINK_TO_PRODUCT_CATEGORY || selectedType === SYNC_WITH_PRODUCT_CATEGORY) && !objectId) {
...
module.exports = __webpack_require__(/*! C:\Users\ACER\Desktop\son\fredom-six\resources\js\admin\menus.edit.js */"./resources/js/admin/menus.edit.js");
