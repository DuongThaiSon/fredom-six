...
$(document).ready(function () {
  ...
  $(".upload-variant-image").on("change.uploadVariantImage", function (e) {
    ...
    $.ajax({
      url: "/admin/products/".concat(productId, "/process"),
      data: formData,
      method: "POST",
      contentType: false,
      processData: false,
...
module.exports = __webpack_require__(/*! C:\Users\ACER\Desktop\son\fredom-six\resources\js\admin\products.edit.js */"./resources/js/admin/products.edit.js");
