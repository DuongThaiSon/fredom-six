...
/***/ "./resources/js/admin/translations.index.js":
/*!**************************************************!*\
  !*** ./resources/js/admin/translations.index.js ***!
  \**************************************************/
/*! no exports provided */
...
$(document).ready(function () {
  ...
  function initLanguageFormData() {
    ...
    $("#translationDetailModal").on('show.bs.modal', function (e) {
      ...
      var translationId = source.data('id');

      var _modal = $(this);

      if (translationId) {
        $.ajax({
          url: "/admin/translations/".concat(translationId, "/edit"),
    ...
    $(".btn-update-translation").on("click.initLanguageFormData", function (e) {
      ...
      var _modal = $("#translationDetailModal");
      ...
      var translationId = _modal.find("input[name=id]").val();
      ...
      $.ajax({
        url: "/admin/translations/".concat(translationId),
        method: 'POST',
        data: formData,
        success: function success() {
          $('#table').DataTable().draw('page');
...
/***/ 18:
/*!********************************************************!*\
  !*** multi ./resources/js/admin/translations.index.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ACER\Desktop\son\fredom-six\resources\js\admin\translations.index.js */"./resources/js/admin/translations.index.js");
