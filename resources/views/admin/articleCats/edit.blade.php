    ...
    <div class="container-fluid" style="background: #e5e5e5;">
        <div id="content">
            ...
            <form action="{{ route('admin.article-categories.update', $category->id) }}" method="POST"
                ...
                <!-- End group button -->
                <!-- Form -->
                <form action="" class="bg-white mt-3 mb-0 p-4 pt-5">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text">Thẻ meta description của trang cung cấp cho Google và các công
                                    cụ tìm kiếm bản tóm tắt nội dung của trang đó. Trong khi tiêu đề trang có thể là vài
                                    từ hoặc cụm từ, thẻ mô tả của trang phải có một hoặc hai câu hoặc một đoạn ngắn.
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text">Meta Keywords (Thẻ khai báo từ khóa trong SEO) Trong quá trình
                                    biên tập nội dung,
                                    Meta Keywords là một thẻ được dùng để khai báo các từ khóa dùng cho bộ máy tìm kiếm.
                                    Với thuộc tính này,
                                    các bộ máy tìm kiếm (Search Engine) sẽ dễ dàng hiểu nội dung của bạn đang muốn nói
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="meta_page_topic"
                                    ...
                                    value="{{ old('meta_page_topic') ?? $category->meta_page_topic }}" />
                                <small class="form-text">Theo chuẩn SEO, thẻ meta page topic sẽ là tiêu điểm của trang
                                    web đang có nội dung nói về chủ đề nào</small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="fileinput fileinput-new d-block" data-provides="fileinput">
                                    ...
                                    <div class="fileinput-new img-thumbnail" style="width: 200px; height: 150px;">
                                        <img src="{{ asset(env('UPLOAD_DIR_ARTICLE', 'media/images/articles')) . "/{$category->avatar}" }}"
                                            alt="...">
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                <textarea class="form-control ckeditor"
                                    name="detail">{{ old('detail') ?? $category->detail }}</textarea>
                            </div>
                        </div>
                    </div>
                </form>
