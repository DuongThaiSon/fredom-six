        ...
        <div id="content">
            ...
            <div class="save-group-buttons">
                ...
                <button id="btn-del-all" data-toggle="tooltip" title="Xóa toàn bộ mục đã chọn"
                    class="btn btn-sm btn-dark delete-all" target="_blank">
            ...
            <div class="card-body">
                <div class="table-responsive bg-white mt-4" id="table"
                    data-reorder="{{ route('admin.article-categories.reorder') }}"
                    data-destroy-many="{{ route('admin.article-categories.destroyMany') }}">
...
@endsection
@push('js')
<script src="{{ asset('assets/admin') }}/js/articleCats.index.js"></script>
@endpush
