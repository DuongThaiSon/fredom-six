            ...
            <form action="{{route('admin.articles.update', $article->id)}}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text">Mã của tin bài</small>
                        </div>

                        <div class="form-group">
                            <label>Tiêu đề bài viết @importantfield</label>
                            <input type="text" name="name" required class="form-control"
                                placeholder="The cat in the hat" value="{{ old('name') ?? $article->name ?? '' }}" />
                        ...
                        <div class="mb-2">
                            ...
                            <input type="checkbox" class="checkbox-toggle" name="is_highlight" id="is_highlight"
                                {{ isset($article)&&$article->is_highlight==1 ? 'checked' : '' }} />
                            <label class="label-checkbox" for="is_highlight">Nổi bật</label>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <input type="checkbox" class="checkbox-toggle" name="is_new" id="is_new"
                                {{ isset($article)&&$article->is_new==1 ? 'checked' : '' }} />
                            <label class="label-checkbox" for="is_new">Mới </label>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <textarea class="form-control ckeditor"
                                name="detail">{{ old('detail') ?? $article->detail ?? '' }}</textarea>
                        </div>
                    </div>
                </div>
            </form>
