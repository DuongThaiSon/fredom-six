        ...
        <div class="bg-white mx-auto border rounded-lg col-6 shadow p-4">
            ...
            <form action="{{ route('admin.password.update') }}" method="POST">
                <div class="row">
                    ...
                    <div class="col-12 form-group mb-3">
                        <label for="input-email" class="mb-2 d-flex align-items-center">
                            <i class="fas fa-unlock" style="font-size: 1.3rem;"></i>&nbsp;<span class="text-dark font-weight-bold">Password</span>
                        </label>
                    ...
                    <div class="col-12 form-group mb-3">
                        <label for="input-email" class="mb-2 d-flex align-items-center">
                            <i class="fas fa-lock" style="font-size: 1.3rem;"></i>&nbsp;<span class="text-dark font-weight-bold">Password Confirmation</span>
                        </label>
                        <div class="input-group">
