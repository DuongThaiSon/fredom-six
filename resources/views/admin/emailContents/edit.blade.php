...
<div id="main-content">
    <div class="container-fluid" style="background: #e5e5e5;">
        <form method="POST" action="{{ route('admin.email-contents.update', $emailContent->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div id="content">
            <h1 class="mt-3 pl-4">
            ...
            <div class="bg-white mb-0 p-4 pt-5">
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                    <textarea class="form-control ckeditor" name="detail">{{ $emailContent->detail }}</textarea>
                    </div>
                </div>
                </div>
            </div>
