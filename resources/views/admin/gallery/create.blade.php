                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="link_to" required class="form-control" placeholder="URL gallery"/>
                    ...
                    <div class="form-group">
                      ...
                      <small class="form-text"
                        >Đặt mục cha cho mục dữ liệu này, mục cha ở đây nghĩa là các mục gallery lớn đã được tạo trước đó.</small
                      >
                    </div>
