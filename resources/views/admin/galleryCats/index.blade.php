    ...
    <div class="container-fluid" style="background: #e5e5e5;">
        <div id="content">
            ...
            <div class="save-group-buttons">
                ...
                <button data-toggle="tooltip" title="Xóa toàn bộ mục đã chọn" class="btn btn-sm btn-dark"
            ...
            <div class="card-body">
                <div class="table-responsive bg-white mt-4" id="table"
                    data-reorder="{{ route('admin.gallery-categories.reorder') }}"
                    data-destroy-many="{{ route('admin.gallery-categories.destroyMany') }}">
...
@endsection
@push('js')
<script src="{{ asset('assets/admin') }}/js/galleryCats.index.js"></script>
@endpush
