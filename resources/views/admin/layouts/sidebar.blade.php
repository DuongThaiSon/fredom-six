    ...
    <section id="sidebar" class="d-flex flex-column">
                ...
                <li class="nav-item has-child">
                    ...
                    <div class="sub collapse" id="submenu1">
                        <ul class="flex-column nav">
                            <li class="nav-item">
                                <a href="{{ route('admin.products.create') }}" class="nav-link menu-products-create">Tạo
                                    mới sản phẩm</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.products.index') }}" class="nav-link menu-products-index">Quản
                                    lý sản phẩm</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.product-attributes.index') }}"
                                    class="nav-link menu-product-attributes-index">Quản lý thuộc tính</a>
                            </li>
                            {{-- <li class="nav-item">
                        <a href="{{ route('admin.products-filters.index') }}" class="nav-link
                            menu-product-filter-category">Quản lý bộ lọc</a>
                </li> --}}
                <li class="nav-item">
                    <a href="{{ route('admin.product-categories.create') }}"
                        class="nav-link menu-product-categories-create">Thêm mới danh mục sản phẩm</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.product-categories.index') }}"
                        class="nav-link menu-product-categories-index">Quản lý danh mục sản phẩm</a>
                </li>
                {{-- <li class="nav-item">
                        <a href="{{ route('admin.excel.index') }}" class="nav-link menu-Upload-products-excel">Upload
                sản phẩm bằng excel</a>
                </li> --}}
            </ul>
        </div>
        </li>
        ...
        {{-- <li class="nav-item has-child">
                    ...
                    <div class="sub collapse" id="partner">
                        <ul class="flex-column nav">
                        <li class="nav-item">
                            <a href="{{ route('admin.partners.create') }}" class="nav-link menu-partner-create">Tạo đối
        tác mới</a>
        </li>
        <li class="nav-item">
...
<li class="nav-item has-child">
    ...
    <div class="sub collapse" id="submenu2">
        <ul class="flex-column nav">
            ...
            <li class="nav-item">
                <a href="{{route('admin.article-categories.create')}}" class="nav-link menu-articleCats-create">Thêm mới
                    danh mục tin bài</a>
            </li>
            <li class="nav-item">
                <a href="{{route('admin.article-categories.index')}}" class="nav-link menu-articleCats">Quản lý danh mục
                    tin bài</a>
            </li>
        </ul>
    </div>
...
<!-- ALBUM -->
<li class="nav-item has-child">
    <a href="#gallerysubmenu" data-toggle="collapse" data-target="#gallerysubmenu" class="nav-link collapsed">
    ...
    <div class="sub collapse" id="gallerysubmenu">
        <ul class="flex-column nav">
            ...
            <li class="nav-item">
                <a href="{{route('admin.galleries.index')}}" class="nav-link menu-galleries-manage"> Quản lý album
                    ảnh</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="{{route('admin.gallery-categories.index')}}" class="nav-link menu-galleriesCat-manage"> Quản lý
                    danh mục album ảnh</a>
            </li>
        </ul>
    </div>
</li>
...
<li class="nav-item has-child">
    ...
    <div class="sub collapse" id="menusubmenu">
        <ul class="flex-column nav">
            <li class="nav-item">
                <a href="{{ route('admin.menu-categories.create') }}" class="nav-link menu-menus-create">Tạo menu
                    mới</a>
            </li>
            <li class="nav-item">
                <a href="{{ route('admin.menu-categories.index') }}" class="nav-link menu-menus-categories">Quản lý
                    menu</a>
            </li>
        </ul>
    </div>
...
<!-- Setting -->
<li class="nav-item has-child">
    <a data-toggle="collapse" data-target="#setting-sub-menu" href="#setting-sub-menu" class="nav-link collapsed"><i
            class="material-icons">settings</i><span>Thiết lập hệ thống</span></a>
...
{{-- <li class="nav-item">
                    <a href="{{ route('admin.settings.sendMail') }}" class="nav-link menu-sendMail">Tài khoản gửi
email</a>
</li> --}}
<li class="nav-item">
