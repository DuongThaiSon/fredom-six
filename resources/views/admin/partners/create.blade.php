@extends('admin.layouts.main', ['activePage' => 'partner-create', 'title' => __('Tạo mới đối tác vận chuyển')])
@section('content')
<div id="main-content">
    <div class="container-fluid" style="background: #e5e5e5;">
        <div id="content">
            <h1 class="mt-3 pl-4">Tạo mới thông tin đối tác vận chuyển</h1>
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" required class="form-control"
                            placeholder="Đơn vị vận chuyển A" value="{{ old('name') }}" />
                        <small class="form-text">Tên của đối tác vận chuyển</small>
                    </div>
                    <div class="form-group">
                        <label>Giá tiền (VNĐ)</label>
                        <input type="text" name="price" required class="form-control"
                            placeholder="{{ number_format('50000') }}" value="{{ old('price') }}" />
