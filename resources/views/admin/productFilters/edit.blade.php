@extends('admin.layouts.main', ['activePage' => 'product-filter-category', 'title' => __('Edit Products Filters')])
@section('content')
<!-- Content -->
<div id="main-content">
      ...
      <div class="row">
        <div class="col-12">
          <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" placeholder="Tên bộ lọc" value="{{ $filter->name }}"/>
