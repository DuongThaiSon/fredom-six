@extends('admin.layouts.main', ['activePage' => 'dashboard', 'title' => __('Edit Email Content')])
@section('content')
<!-- Content -->
<div id="main-content">
  <div class="container-fluid" style="background: #e5e5e5;">
    <form method="POST" action="{{ route('admin.setting.postEditEmailContent', $email_content->id) }}" enctype="multipart/form-data">
      @csrf
      <div id="content">
        <h1 class="mt-3 pl-4">
          NỘI DUNG EMAIL
