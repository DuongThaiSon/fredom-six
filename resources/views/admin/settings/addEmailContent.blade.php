@extends('admin.layouts.main', ['activePage' => 'emailContent', 'title' => __('Add Email Content')])
@section('content')
<!-- Content -->
<div id="main-content">
  <div class="container-fluid" style="background: #e5e5e5;">
    <form method="POST" action="{{ route('admin.settings.postAddEmailContent') }}" enctype="multipart/form-data">
      @csrf
      <div id="content">
        <h1 class="mt-3 pl-4">
          NỘI DUNG EMAIL
