@extends('admin.layouts.main', ['activePage' => 'infoSetting', 'title' => __('Info setting')])
@section('content')
<!-- Content -->
<div id="main-content">
  <div class="container-fluid" style="background: #e5e5e5;">
    <form method="POST" action="{{ route('admin.settings.postInfoSetting')}}" enctype="multipart/form-data">
        @csrf
    <div id="content">
