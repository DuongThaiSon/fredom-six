@extends('admin.layouts.main', ['activePage' => 'users-admins', 'title' => __('Edit Member')])
@section('content')
<!-- Content -->
<div id="main-content">
    <div class="container-fluid" style="background: #e5e5e5;">
        <div id="content">
            ...
            <form action="{{ route('admin.users.admins.update', $user->id) }}" class="mb-0 p-4 bg-white" method="POST"
