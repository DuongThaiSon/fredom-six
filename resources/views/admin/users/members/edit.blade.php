@extends('admin.layouts.main', ['activePage' => 'users-members', 'title' => __('Edit Member')])
@section('content')
<!-- Content -->
<div id="main-content">
    <div class="container-fluid" style="background: #e5e5e5;">
        <div id="content">
            ...
            <form action="{{ route('admin.users.members.update', $user->id) }}" class="mb-0 p-4 bg-white" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-7 col-sm-12">
                        ...
                        <div class="form-group pb-4 pt-2">
                            ...
                            <div class="pretty p-icon p-round p-plain p-smooth p-bigger mt-2">
                                <input type="radio" name="status" value="not_verified" {{ !$user->email_verified_at ? 'checked' : '' }}>
                                <div class="state">
                            ...
                            <div class="pretty p-icon p-round p-plain p-smooth p-bigger mt-2">
                                <input type="radio" name="status" value="active" {{ $user->email_verified_at && $user->is_active ? 'checked' : '' }}>
                            ...
                            <div class="pretty p-icon p-round p-plain p-smooth p-bigger mt-2">
                                <input type="radio" name="status" value="disabled" {{ $user->email_verified_at && !$user->is_active ? 'checked' : '' }}>
                                <div class="state p-danger-o">
...
@push('js')
<script src="/assets/admin/js/users.members.create.js"></script>
@endpush
@endsection
