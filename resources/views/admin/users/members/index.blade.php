@extends('admin.layouts.main', ['activePage' => 'users-members', 'title' => __('List Members')])
@section('content')
<!-- Content -->
<div id="main-content">
        ...
        <div id="content">
            ...
            <div class="save-group-buttons">
                <a class="btn btn-sm btn-dark" data-toggle="tooltip" title="Thêm thành viên mới"
                    href="{{ route('admin.users.members.create')}}">
            ...
            <div class="bg-white mt-4">
                <table class="table-sm table-hover table mb-2" width="100%" id="table" data-url="{{ route('admin.users.members.list') }}" data-destroy-many="{{ route('admin.users.members.destroyMany') }}">
                    <thead>
                        <tr class="text-muted">
...
@endsection
@push('js')
<script src="{{ asset('assets/admin') }}/js/users.members.index.js"></script>
@endpush
