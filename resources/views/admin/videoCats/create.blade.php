 ...
 <div id="main-content">
          <div class="container-fluid" style="background: #e5e5e5;">
            <div id="content">
              ...
              <form action="{{route('admin.video-categories.store')}}" method="POST" enctype="multipart/form-data" class="bg-white mt-3 mb-0 p-4 pt-5">
              @csrf
              @if ($errors->any())
              ...
              <div class="save-group-buttons">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label>Tên mục</label>
                      <input type="text" name="name" required class="form-control" placeholder="Tên mục" value="{{old('name')}}"/>
                    ...
                    <input type="checkbox" class="checkbox-toggle" checked="checked" value="1" name="is_highlight" id="highlight" />
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="meta_title" placeholder="Tiêu đề Browser (title)"/>
