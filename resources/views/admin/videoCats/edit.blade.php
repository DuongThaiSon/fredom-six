@extends('admin.layouts.main', ['activePage' => 'videos', 'title' => __('Category Detail')])
@section('content')
 <div id="main-content">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label>ID</label>
                      <input type="text" name="id" class="form-control" readonly="readonly" value="{{$category->id}}"/>
                      <small class="form-text">ID là mã của album, đây là một thuộc tính duy nhất</small>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <small class="form-text">Đặt mục cha cho mục dữ liệu này, bạn có thể để trống để hiểu rằng đây là mục lớn nhất</small>
                    </div>
