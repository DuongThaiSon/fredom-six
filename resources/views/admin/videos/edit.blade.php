            ...
            <form action="{{route('admin.videos.update', $video->id)}}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="slug" placeholder="Thẻ Meta Description"
                                value="{{ old('meta_description') ?? $video->meta_description ?? '' }}" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="slug" placeholder="Thẻ Meta keywords"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="slug" placeholder="Thẻ Meta Page Topic"
                                value="{{ old('meta_page_topic') ?? $video->meta_page_topic ?? '' }}" />
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <textarea class="form-control ckeditor"
                                name="detail">{{ old('detail') ?? $video->detail ?? '' }}</textarea>
                        </div>
                    </div>
                </div>
            </form>
